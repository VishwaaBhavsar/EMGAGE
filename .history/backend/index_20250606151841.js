...
// // Updated Socket.IO configuration with proper CORS
// const io = socketIo(server, {
//   cors: {
//     origin: [
...
// // Alternative: Allow all origins in development (less secure but more flexible)
// // const io = socketIo(server, {
// //   cors: {
// //     origin: "*",
// //     methods: ["GET", "POST"],
...
//     try {
//       const { userId, username } = userData;
//       console.log('User join request:', userId, username);
...
//       const savedMsg = await saveMessage(senderId, receiverId, message, senderName);

//       // Emit message to receiver if online
//       const receiver = onlineUsers.get(receiverId);
//       if (receiver) {
//         io.to(receiver.socketId).emit('receive_message', savedMsg);
//       }
...
//     } catch (error) {
//       console.error('Error getting messages:', error);
//       socket.emit('error', { message: 'Failed to get messages', details: error.message });
//     }
//   });
...
//       io.emit('users_update', {
//         onlineUsers: Array.from(onlineUsers.values()),
//         contacts: Array.from(onlineUsers.values()).map(user => ({
//           id: user.id,
//           name: user.username,
//           status: 'online'
//         }))
